...
export async function POST(req: Request) {
  try {
    ...
    // Clean up old sessions — delete in FK dependency order
    await prisma.$transaction([
      prisma.debriefResponse.deleteMany(),
      prisma.promiseCheck.deleteMany(),
      prisma.scandalVolley.deleteMany(),
      prisma.scandalAlliance.deleteMany(),
      prisma.scandal.deleteMany(),
